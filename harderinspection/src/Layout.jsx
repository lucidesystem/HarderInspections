      ...
      <header className="main-header">
        ...
        <nav className="navbar">
          ...
          <div className="logo">
            <Link to="/" style={{ textDecoration: 'none' }}>
              <img src="./images/Logo.jpg" alt="" id="headerlogo" />
            </Link>
          </div>
        ...
        <aside className={`mobile-sidebar ${sidebarOpen ? 'active' : ''}`}>
          ...
          <ul className="sidebar-links">
            ...
            <li><Link to="/services" onClick={closeSidebar}>Services/Rates</Link></li>
            <li><Link to="/radon" onClick={closeSidebar}>Radon</Link></li>
