      ...
      <section className="intro-section">
        <div className="container">
          ...
          <div className="intro-text">
            ...
            <p style={{ marginTop: '20px' }}>
              <strong>"I understand that buying a home is one of the largest investments we make in our lives. It is my commitment to you that you fully understand the condition of the property prior to closing in an effort to help you make a more informed decision as a buyer." David Harder</strong>
            </p>
